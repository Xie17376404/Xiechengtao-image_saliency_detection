...
class SODLoader(Dataset):
    ...
    def __init__(self, mode='train', augment_data=False, target_size=256):
        if mode == 'train':
            self.inp_path = './dataset/3-Saliency-TrainSet/Stimuli/Action'
            self.out_path = './dataset/3-Saliency-TrainSet/FIXATIONMAPS/Action'
        elif mode == 'test':
            self.inp_path = './dataset/3-Saliency-TestSet/Stimuli/Action'
            self.out_path = './dataset/3-Saliency-TestSet/FIXATIONMAPS/Action'
        else:
